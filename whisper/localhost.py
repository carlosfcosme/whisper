"""Loopback bind address and download URL policy.

Servers bind ``127.0.0.1``. Hugging Face Hub URLs are never fetched.
Hostnames are not resolved (no DNS rebinding).
"""
...
def bind_host() -> str:
    """Address to bind local servers to. Always IPv4 loopback."""
