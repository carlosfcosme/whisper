...
Listeners must bind ``127.0.0.1``. Empty host and all-interface addresses
are refused before ``bind()``. This module does not load weights or secrets.
"""
...
# Built without an all-interface literal so serve/listen sources stay free
