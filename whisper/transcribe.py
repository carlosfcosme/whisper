...
def cli():
    ...
    parser.add_argument("--device", default="cuda" if torch.cuda.is_available() else "cpu", help="device to use for PyTorch inference; defaults to cpu when CUDA is unavailable")
