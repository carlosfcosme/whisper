...
Tracked checkpoints (``.pt``, ``.safetensors``, …) and any file over 10 MiB
make CI fail. Fixtures such as ``tests/jfk.flac`` stay under the size cap.
"""
...
def reasons_committed_weights(
    ...
    """Return reasons the tree contains committed weights or huge binaries."""
    if entries is None:
