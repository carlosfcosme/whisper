...
Weights belong in a runtime cache, not in git. Invoked from GitHub Actions
and pre-commit.
"""
...
# under this (largest tracked source asset is well below 10 MiB).
...
def main() -> int:
    ...
    if violations:
        ...
        sys.stderr.write("Download weights at runtime; do not add them to git.\n")
        return 1
