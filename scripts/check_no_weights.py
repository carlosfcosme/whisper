#!/usr/bin/env python3
"""Fail CI if model weights or oversized binaries are committed."""
...
# Official Whisper checkpoints start ~75 MiB. Largest tracked file today
# is notebooks/Multilingual_ASR.ipynb (~5.7 MiB).
...
def main() -> int:
    ...
    if violations:
        ...
        sys.stderr.write(
            "Do not commit weights. Use a local cache; no Hub and no weight pulls.\n"
        )
        return 1
